...
public class Constants {
    ...
    public final static String PG_HOST="PG_HOST";
    public final static String PG_USERNAME="PG_USERNAME";
    ...
    public final static String S3_KEY="S3_KEY";
    ...
    public final static String REDSHIFT_STAGE_TABLE_NAME="REDSHIFT_STAGE_TABLE_NAME";
